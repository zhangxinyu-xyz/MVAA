...
function selectCompVideo(methodPill, scenePill, textprompt) {
    ...
    // video_active.src = "assets/videos/comparison/" + pill + "/" + method + "_vs_ours_" + mode + ".mp4";
    // video_active.src = "assets/videos/comparison/" + pill + "/" + method + "_vs_ours_" + textprompt + ".mp4";
    video_active.src = "assets/videos/comparison/" + method + "/" + textprompt + ".mp4";
    video_active.load();
